...
var ApimapSender = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ApimapSender, [{
    ...
    key: "_send",
    value: function _send(envSecret, data, path) {
      var _this = this;
      return this.superagentRequest.post("".concat(this.forestUrl, "/").concat(path)).set('forest-secret-key', envSecret).send(data).then(function (result) {
    ...
    key: "checkHash",
    value: function checkHash(envSecret, schemaFileHash) {
      return this._send(envSecret, {
        schemaFileHash: schemaFileHash
