...
var _excluded = ["all_records", "all_records_ids_excluded", "all_records_subset_query", "parent_association_name", "parent_collection_name", "parent_collection_id"];
...
function QueryDeserializer(attributes) {
  this.perform = function () {
    var allRecords = attributes.all_records,
      ...
      rest = (0, _objectWithoutProperties2["default"])(attributes, _excluded);
