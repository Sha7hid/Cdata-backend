...
function Checker(opts, Implementation) {
  ...
  function isMappingValid() {
    ...
    if (!mappingValid) {
      logger.error("Cannot find some Layer integration mapping values (".concat(opts.integrations.layer.mapping, ") among the project models:\n").concat(_.keys(models).join(', ')));
    }
    return mappingValid;
  }
  ...
  this.defineCollections = function (collections) {
    ...
    _.each(opts.integrations.layer.mapping, function (collectionAndFieldName) {
