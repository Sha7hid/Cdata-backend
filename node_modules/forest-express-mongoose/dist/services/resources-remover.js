...
var ResourcesRemover = /*#__PURE__*/function () {
  function ResourcesRemover(model, params, ids, user) {
    (0, _classCallCheck2["default"])(this, ResourcesRemover);
    this._model = model;
    this._params = params;
    this._ids = ids;
    this._user = user;
  }
  (0, _createClass2["default"])(ResourcesRemover, [{
    key: "perform",
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return _context.abrupt("return", this._model.deleteMany({
                _id: this._ids
              }));
            case 6:
    ...
    key: "_isAllowed",
    value: function () {
      var _isAllowed2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var params;
